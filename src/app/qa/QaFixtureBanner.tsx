 ...
 *
 * Import this into any page that receives a class slug and render it
 * at the top. If the slug is not a QA fixture, the component returns
 * null and takes no layout space.
 */
export default function QaFixtureBanner({ classSlug }: { classSlug: string }) {
